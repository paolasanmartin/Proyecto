"""
Django settings for redSocialMAscotas project.
...
SECRET_KEY = 't9t2_+#%1xl0op$&1-3lcfi516roo%v7=nmx7t4_6n8*f=pd1!'
...
ROOT_URLCONF = 'redSocialMAscotas.urls'
...
WSGI_APPLICATION = 'redSocialMAscotas.wsgi.application'
